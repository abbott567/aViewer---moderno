...
final class Localization {
    ...
    private static let builtIn: [String: String] = [
        ...
        "PermissionMessage": "aViewer reads other applications through the macOS accessibility API. Grant access in System Settings > Privacy & Security > Accessibility, then return here.",
        ...
        "PermissionGrantedStatus": "Accessibility access granted",
